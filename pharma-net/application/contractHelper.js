...
async function getContractInstance(orgType) {
	...
	// A CCP is defined manually in file connection-profile-common.yaml
	gateway = new Gateway();
	...
	let connectionProfile = yaml.safeLoad(fs.readFileSync('./connection-profile-common.yaml', 'utf8'));
